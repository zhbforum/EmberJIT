if(NOT DEFINED EXPECTED_OUTPUT_FILE OR NOT DEFINED EXPECTED_TRACE_FILE OR
   NOT DEFINED JIT_THRESHOLD)
    message(FATAL_ERROR
        "Expected output, trace, and threshold inputs must be defined."
    )
endif()

execute_process(
    COMMAND "${EMBER}" run --no-jit "--jit-threshold=${JIT_THRESHOLD}"
            --trace-jit "${SOURCE_FILE}"
